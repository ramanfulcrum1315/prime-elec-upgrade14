              ...
              #print_r($link);
						...
						foreach ($product->getOptions() as $o) {
							...
							if($o->getData('type')=="drop_down") {
								...
								$customoptionvalues .= $o->getData('title') . ":" . $price_type . ":" . $price . ":" . $sku . ":" . $sort_order . "|";
							}
							/*
							foreach ( $o->getValues() as $oValues ) {
								if($oValues->getData('price_type')=="") { $price_type = "fixed"; } else { $price_type = $oValues->getData('price_type'); }
							...
							if($o->getData('type') == "field") {
								#if(!is_numeric($o->getData('sort_order'))) { echo "T"; $sort_order_field = "0"; } else { echo "T2"; $sort_order_field = $o->getData('sort_order'); }
								if(!is_numeric($o->getData('max_characters'))) { $sort_order_field = "0"; } else { $sort_order_field = $o->getData('max_characters'); }
								
								$customoptionvalues .= $o->getData('title') . ":" . $o->getData('price_type') . ":" . $o->getData('price') . ":" . $o->getData('sku') . ":" . $sort_order_field . "|";
							}
							*/
