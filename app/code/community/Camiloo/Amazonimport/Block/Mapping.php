...
class Camiloo_Amazonimport_Block_Mapping extends Mage_Adminhtml_Block_Widget_Grid_Container
{
  public function __construct()
  {
    $this->_controller = 'mapping';
    $this->_blockGroup = 'amazonimport';
    $this->_headerText = Mage::helper('amazonimport')->__('Country Specific Mappings');
    parent::__construct();
