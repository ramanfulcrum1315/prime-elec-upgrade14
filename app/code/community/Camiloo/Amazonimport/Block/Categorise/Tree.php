 ...
 */
class Camiloo_Amazonimport_Block_Categorise_Tree extends Mage_Adminhtml_Block_Catalog_Category_Abstract
{
    ...
    {
        parent::__construct();
        $this->setTemplate('amazonimport/categorise/tree.phtml');
    ...
    {
        $rootArray = $this->_getNodeJson($this->getRoot($parenNodeCategory));
        $json = json_encode(isset($rootArray['children']) ? $rootArray['children'] : array());
        return $json;
    }
