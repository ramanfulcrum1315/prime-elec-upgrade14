...
class Camiloo_Amazonimport_Block_Manualsetup_Categorychange_Edit_Tab_Browsenodegrid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/*/getbrowsenodegrid', array('_current'=>true));
    }
	
  public function getRowUrl($row)
  {
      return 'javascript:selectedBrowseNode(\''.$row->getData('browsenode_id').'\');';
  }
