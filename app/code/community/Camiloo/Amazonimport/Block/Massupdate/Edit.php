...
class Camiloo_Amazonimport_Block_Massupdate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
            return Mage::helper('amazonimport')->__('Mass Update Tool'); 
    }
}