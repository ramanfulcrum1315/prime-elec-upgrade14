<?php
/*
$Id: nusoapmime.php,v 1.2 2010/07/19 11:32:09 matthew Exp $
...
* @version  $Id: nusoapmime.php,v 1.2 2010/07/19 11:32:09 matthew Exp $
* @access   public
*/
class nusoap_client_mime extends nusoap_client {
	...
	* @access public
	*/
	function addAttachment($data, $filename = '', $contenttype = 'text/xml', $cid = false) {
		if (! $cid) {
			$cid = md5(uniqid(time()));
		}
