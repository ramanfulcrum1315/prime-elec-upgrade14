...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportsetupuk extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportsetupuk/amazonimportsetupuk', 'setup_id');
    }
}