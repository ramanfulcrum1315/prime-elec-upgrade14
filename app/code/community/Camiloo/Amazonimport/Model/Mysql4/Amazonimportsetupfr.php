...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportsetupfr extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportsetupfr/amazonimportsetupfr', 'setup_id');
    }
}