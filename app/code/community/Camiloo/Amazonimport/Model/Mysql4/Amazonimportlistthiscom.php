...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportlistthiscom extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportlistthiscom/amazonimportlistthiscom', 'list_id');
    }
}