...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportsetupcom extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportsetupcom/amazonimportsetupcom', 'setup_id');
    }
}