...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportlistthisde extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportlistthisde/amazonimportlistthisde', 'list_id');
    }
}