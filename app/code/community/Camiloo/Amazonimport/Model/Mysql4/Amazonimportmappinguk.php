...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportmappinguk extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportmappinguk/amazonimportmappinguk', 'mapping_id');
    }
}