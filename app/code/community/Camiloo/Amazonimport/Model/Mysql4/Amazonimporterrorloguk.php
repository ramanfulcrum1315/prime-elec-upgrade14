...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimporterrorloguk extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimporterrorloguk/amazonimporterrorloguk', 'elog_id');
    }
}