...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportmappingfr extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportmappingfr/amazonimportmappingfr', 'mapping_id');
    }
}