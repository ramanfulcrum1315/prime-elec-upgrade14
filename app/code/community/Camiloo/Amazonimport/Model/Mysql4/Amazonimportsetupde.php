...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportsetupde extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportsetupde/amazonimportsetupde', 'setup_id');
    }
}