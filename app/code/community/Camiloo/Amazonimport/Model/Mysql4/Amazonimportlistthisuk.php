...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportlistthisuk extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportlistthisuk/amazonimportlistthisuk', 'list_id');
    }
}