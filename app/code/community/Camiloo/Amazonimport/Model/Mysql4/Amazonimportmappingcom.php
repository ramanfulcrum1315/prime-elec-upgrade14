...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportmappingcom extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportmappingcom/amazonimportmappingcom', 'mapping_id');
    }
}