...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportmappingde extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportmappingde/amazonimportmappingde', 'mapping_id');
    }
}