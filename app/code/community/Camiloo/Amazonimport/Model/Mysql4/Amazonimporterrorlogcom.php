...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimporterrorlogcom extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimporterrorlogcom/amazonimporterrorlogcom', 'elog_id');
    }
}