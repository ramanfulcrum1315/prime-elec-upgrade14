...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportbrowsenodes extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportbrowsenodes/amazonimportbrowsenodes', 'bnid');
    }
}