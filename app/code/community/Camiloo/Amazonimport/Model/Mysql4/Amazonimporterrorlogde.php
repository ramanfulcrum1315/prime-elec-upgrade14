...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimporterrorlogde extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimporterrorlogde/amazonimporterrorlogde', 'elog_id');
    }
}