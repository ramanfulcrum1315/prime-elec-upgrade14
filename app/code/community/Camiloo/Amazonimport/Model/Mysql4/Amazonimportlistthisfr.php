...
class Camiloo_Amazonimport_Model_Mysql4_Amazonimportlistthisfr extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('amazonimportlistthisfr/amazonimportlistthisfr', 'list_id');
    }
}