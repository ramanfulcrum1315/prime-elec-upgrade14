...
class Camiloo_Amazonimport_Model_Overview extends Mage_Adminhtml_Block_Dashboard_Abstract
{
    ...
    protected $_width = '580';
    protected $_height = '110';
    ...
    public function getChartUrl($directUrl = true, $storeid='')
    {
		
        $this->setDataHelperName('adminhtml/dashboard_order');
        $this->getDataHelper()->setParam('store', $storeid);
        $this->getDataHelper()->setParam('period','24h');
	  ...
	  public function getMiniChartUrl($directUrl = true, $storeid='',$period='24h')
    {
        $this->setDataHelperName('adminhtml/dashboard_order');
        $this->getDataHelper()->setParam('store', $storeid);
        ...
        $params = array(
            'cht' => 'lc',
            'chf' => 'bg,s,FAFAFA|c,lg,90,FAFAFA,0.1,ededed,0',
            'chm' => 'B,f4d4b2,0,0,0',
            'chco' => 'FAFAFA'
        );
